...
export class IStoreService {
	// direct<
	// 	Fn extends keyof SteamFunctions<"IStoreService">,
	// 	Schema extends ArrayValues<Parameters<SteamFunctions<"IStoreService">[Fn]>>,
	// 	Args extends v.InferInput<Schema>
	// >(fn: Fn, args: Args) {
	// 	if (fn === "getAppList") {
	// 		return this.getAppList(args as v.InferInput<typeof GetAppListSchema>);
	// 	}
	// }
	...
	public async getAppList(args: v.InferInput<typeof GetAppListSchema>) {
		...
		return objectToCamel(v.parse(GetAppListOutputSchema, json)) as GetAppListOutput;
	}
